...
export default function ImageWrapper(props:ImageConfig) {
  ...
  const {imgSource,sourceType, accelRate,maxPanRate,zoomRate,zoomMax,fHeight,fWidth,style} = props
  const imgProps = {imgSource,sourceType,accelRate,maxPanRate,zoomRate,zoomMax,fHeight,fWidth}
